...
func subsetByGWzones(s *Structure, w *Subwatershed, m *Mapper, gwids []int) {
	...
	newFngwc, mg := make([]float64, len(gwids)), make(map[int]int)
	for i, g := range gwids {
		mg[g] = i
